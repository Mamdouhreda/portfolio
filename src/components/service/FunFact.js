const funFacts = [
  ...
  { id: 2, value: "9K+", name: "Lines of Code" },
];

const FunFact = () => {
  return (
    <div className="tokyo_tm_facts w-full h-auto clear-both bg-white float-left px-0 pt-[100px] pb-[60px]">
      <div className="container">
        ...
        <div className="list w-full h-auto clear-both float-left">
          <ul className="ml-[-40px] list-none">
            {funFacts.map((item) => (
              <li
                className="mb-[40px] pl-[40px] w-1/2 float-left"
                key={item.id}
              >

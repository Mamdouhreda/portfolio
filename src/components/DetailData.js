const detailData = [
  {
    id: 1,
    thumbnail: "assets/img/portfolio/popup/places1.jpg",
    title: "World Wonders & UK City Search",
    text: [
      "Section 1: Wonders of the World",
      "Explore the awe-inspiring global landmarks through this interactive display. Leveraging Google's Places APIs, this section generates information cards for each wonder, creating a rich and engaging user experience. It is complemented by a visually appealing slider that showcases captivating images of these iconic landmarks, fetched dynamically using the Place Photos API.",
      "Section 2: City Search",
      "Discover UK cities with ease and efficiency using the dynamic search tool. This feature provides real-time autocomplete results sourced from Google's Autocomplete API, tailoring the user's search experience. Each city search result comes with a handy \"Get Directions\" link, opening up a convenient Google Maps view to facilitate further exploration. Emphasizing user feedback, the feature includes helpful error messages to ensure a seamless browsing experience.",
    ],
    client: "My Project",
    date: "July 31, 2023",
    category: "PHP, JavaScript, Craft CMS, Google's Places IDs API, Google's Autocomplete API, Tailwind CSS",
    share: [
      {
        id: 1,
        iconName: "icon-github-squared",
        link: "https://github.com/Mamdouhreda/WondersAndUkCities",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    client: "My Project",
    date: "August 1, 2022",
    category: "React,Javascript, Tailwind CSS, HTML, OpenWeather API",
    share: [
      {
        id: 1,
        iconName: "icon-link-1",
        link: "https://weather.mamdouh.co.uk/",
      },
      {
        id: 2,
        iconName: "icon-github-squared",
  ...
  {
    id: 8,
    thumbnail: "assets/img/portfolio/popup/netflix.jpg",
    title: "Netflix Clone Web Porject",
    text: [
      "🍿 Excited to share my Netflix clone web application, beautifully designed with React, Tailwind CSS, and Firebase! ",
      "\n 🍿 In this project, I've developed an intuitive and user-friendly streaming service that mimics the Netflix experience. Using React for efficient and interactive UI, Tailwind CSS for custom styling, and Firebase for secure back-end services, this platform is a synergy of functionality and appealing aesthetics.",
      "\nThe application fetches data from a mocked API (as an example), allowing users to browse through various genres and categories of movies and TV shows. Furthermore, Firebase has been integrated to provide reliable user authentication features and to handle the back-end data storage and retrieval, ensuring a personalized and secure user experience.",
      "\n🚀 Key Features:",
      "- User Authentication: Integrated Firebase to provide secure sign-in and sign-up features.",
      "- Media Browsing: Users can browse various categories and genres of movies and TV shows.",
      "- Media Playback: Integrated media player for a seamless streaming experience.",
      "- Responsive Design: Tailwind CSS was used to ensure a seamless, user-friendly experience across all device types and screen sizes.",
      "- Back-end Connection: Leveraged Firebase for back-end connections, ensuring efficient data management and secure authentication.",
      "\nCreating this project was an enriching journey that allowed me to explore the versatility of React, the flexibility of Tailwind CSS for frontend development, and the powerful back-end capabilities of Firebase. I'm thrilled about its potential for further development and improvement.",
    ],
    client: "My Project",
    date: "August 1, 2022",
    category: "React, Javascript, Tailwind CSS, HTML",
    share: [
      {
        id: 1,
        iconName: "icon-link-1",
        link: "https://netflixclone.mamdouh.co.uk/",
      },
      {
        id: 2,
        iconName: "icon-github-squared",
        link: "https://github.com/Mamdouhreda/netflixClone",
      },
    ],
    bigImage: "",
    images: [],
